$user = "theadmin" 
$pwd1 = "xfg@@#3456hhJ"
$password = ConvertTo-SecureString $pwd1 -AsPlainText -Force
$Credential = New-Object System.Management.Automation.PSCredential $user, $password

$waitTimeMilliseconds = 3 * 60 * 1000 # TODO: modify me
...
#temporary script file solution that delete'S itself after use

$tempScript = "C:\Users\theadmin\temp-$PID.ps1"

"$scriptBlock; Remove-Item `$PSCommandPath" | Out-file $tempScript


Start-Process powershell.exe -Credential $Credential -ArgumentList @("-ExecutionPolicy unrestricted -NonInteractive -nologo -noexit -file `"$tempScript`"")
...
#(New-Object System.Net.WebClient).DownloadString('https://get.scoop.sh')  | Out-file $tempScript

#Start-Process powershell.exe -Credential $Credential -ArgumentList @("-ExecutionPolicy unrestricted -NonInteractive -nologo -noexit scoop install python")
