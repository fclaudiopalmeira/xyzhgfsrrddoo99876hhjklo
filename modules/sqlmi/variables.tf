...
#### TAGGING SETION
  ...
  description = "Date for the application to be decomissioned"

  }
  variable "MaintenanceWindow" {
  description = "Application Maintenance Windows"

  }
  variable "Module" {
  description = "Module Utilised to deploy the Application"
  ...
  description = "Email of the team/person responsible for the application"
